...
$factory->state(\App\Cliente::class, 'pessoa_fisica', function (\Faker\Generator $faker){
    $cpfs = cpfs();
   return [
       ...
       'pessoa' => \App\Cliente::PESSOA_FISICA
   ];
});
$factory->state(\App\Cliente::class, 'pessoa_juridica', function (\Faker\Generator $faker){
    $cnpjs = cnpjs();
    return [
        'documento' => $cnpjs[array_rand($cnpjs,1)],
        'fantasia' => $faker->company,
        'pessoa' => \App\Cliente::PESSOA_JURIDICA
    ];
});